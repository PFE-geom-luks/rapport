...
l'utilisation globale est visible sur la \textit{Figure \ref{fig:fonctions_md}}.
Cette utilisation se fait également à travers la structure \texttt{softc}
(\textit{Figure \ref{fig:fonctions_sc}}), qui désigne les données privées de
l'instance GEOM. Leur modification équivaudrait à une refonte assez importante
du code.
\paragraph{}
\begin{figure}[h]
\centering
