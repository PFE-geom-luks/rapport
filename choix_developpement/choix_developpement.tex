...
modifier les structures \texttt{metadata} et \texttt{softc} héritées de
...
créé un disque à partir d'un autre, la structure comprends notamment, la taille
...
Avec les métadonnées de {\em LUKS} on a directement le champs {\em payloadoffset}
...
ce décalage. {\em GELI} ne prévoyant pas de réaliser cette opération, on rajoute
