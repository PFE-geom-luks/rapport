...
% TODO: Vérifier en faisant make et make install
\paragraph{}
...
% TODO: man 3 SHA512 et man 9 SHA512 pour préciser les deux bibliothèques qui diffèrent
...
% TODO: schéma expliquant l'utilisation/dépendance de pkcs5v2_genkey avec g_eli_hmac.c
...
donc savoir si l'utilisation de {\em PKCS5v2} et du {\em HMAC} en espace
utilisateur est indispensable.

\paragraph{}
Le fichier {\em geom\_eli.c} révèle que ces fonctions sont utilisée pour réaliser
des opérations sur la phrase de passe, qui sont donc réalisée uniquement ou
