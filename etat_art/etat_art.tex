...
le module {\em dm-crypt} est n'a pas connaissance de l'existance de métadonnées ainsi 
...
{\em dm-crypt} est n'a pas connaissance des algorithmes de chiffrement disponibles,
