...
\\
Le BIOS premier programme démarre et permet de lancer le bootloader, qui se
charge de lancer le système, en lançant l'inital ramdisk, qui est un noyau
...
chiffré, il est plus courant de trouver une configuration avec une seule
partition regroupant le {\em /} et le {\em /boot}.
