...
programme qui est fournit par {\em Linux} en tant qu'utilitaire, qui est géré
par une équipe indépendante de celle du noyau {\em Linux}. De plus 
...
noyau {\em Linux} peut mettre à disposition via son API.
...
\paragraph{}
Tandis qu'encore une fois pour {\em LUKS}, la liste des algorithmes autorisée,
n'est pas précisée, c'est donc celle que le noyau {\em Linux} peut mettre à 
disposition qui est disponible.
